...
VL_MODULE(Vtop) {
  public:
    ...
    CData/*7:0*/ top__DOT__ex04__DOT__A_reg;
    CData/*7:0*/ top__DOT__ex04__DOT__B_reg;
    SData/*15:0*/ top__DOT__ex04__DOT__P_reg;
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ __Vclklast__TOP__clk_i;
    CData/*7:0*/ top__DOT____Vcellinp__ex04__data_i[2];
